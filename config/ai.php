...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Default models used by BELA for text generation and embeddings. You may
    | override them on a per-agent basis using the #[Model] attribute.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Storage configuration used by the AI SDK conversation features.
    |
    */
